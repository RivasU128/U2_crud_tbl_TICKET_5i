...
<body class="bg-light">
    ...
    <div class="container mt-5">
        ...
        <div class="card mb-5">
            ...
            <!-- tambah data -->
            <div class="card-body">
                <h3 class="card-title">Tabla ticket</h3>
                <p class="card-text">Tala en la que se guarda todos los datos que identifican a una compra como lo son el precio del producto, la cantidad de este o el número de factura</p>
                ...
                <form class="row g-3" action="tambah.php" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nom_empleado" class="form-control" placeholder="nom_empleado" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        <label for="NIM" class="form-label">Cantidad</label>
                        <input type="text" name="cantidad" class="form-control" placeholder="cantidad" required>
                    </div>

                    <div class="col-md-6">
                        <label for="NIM" class="form-label">Nombre del producto</label>
                        <input type="text" name="nom_producto" class="form-control" placeholder="nom_producto" required>
                    </div>

                    <div class="col-md-6">
                        <label for="Jurusan" class="form-label">Correo del clíente</label>
                        <input type="text" name="correo_cliente" class="form-control" placeholder="correo_cliente" required>
                    </div>

                    <div class="col-md-12">
                        <label for="Jurusan" class="form-label">Número de factura</label>
                        <input type="text" name="num_factura" class="form-control" placeholder="num_factura" required>
                    </div>

                    <div class="col-12">
                        <button type="submit" class="btn btn-primary" value="daftar" name="registrar"><i class="fa fa-plus"></i><span class="ms-2">Registrar datos del ticket</span></button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="table-responsive mb-5 card">
            ...
            echo "<th scope='col' class='text-center'>Nombre del empleado</th>";
            ...
            echo "<th scope='col' class='text-center'>Nombre del producto</th>";
            echo "<th scope='col' class='text-center'>Correo del cliente</th>";
            echo "<th scope='col' class='text-center'>Número de factura</th>";
            ...
            $datos = mysqli_query($conexion, "SELECT * FROM ticket");
            $cantidad_de_datos = mysqli_num_rows($datos);
            $paginas_totales = ceil($cantidad_de_datos / $limite);

            $datos_mostrados = mysqli_query($conexion, "SELECT * FROM ticket LIMIT $inicio_limite, $limite");
            ...
            while ($envio = mysqli_fetch_array($datos_mostrados)) {
                echo "<tr>";
                echo "<td style='display:none'>" . $envio['id_ticket'] . "</td>";
                echo "<td class='text-center'>" . $id_envio++ . "</td>";
                echo "<td class='text-center'>" . $envio['nom_empleado'] . "</td>";
                echo "<td class='text-center'>" . $envio['telefono'] . "</td>";
                echo "<td class='text-center'>" . $envio['precio'] . "$</td>";
                echo "<td class='text-center'>" . $envio['cantidad'] . "</td>";
                echo "<td class='text-center'>" . $envio['nom_producto'] . "</td>";
                echo "<td class='text-center'>" . $envio['correo_cliente'] . "</td>";
                echo "<td class='text-center'>" . $envio['num_factura'] . "</td>";
...
<!-- ------------------------------------------------------------------------------------------------------------------ -->
                    ...
                    <form action='edit.php' method='POST'>
                        <div class='modal-body text-start'>
                            <input type='hidden' name='id_ticket' id='id_envio'>

                            <div class="col-12 mb-3">
                                <label for="edit_NIM" class="form-label">Nombre del empleado</label>
                                <input type="text" name="nuevo_nom_empleado" id="edit_id_producto" class="form-control" placeholder="nom_empleado" required>
                            </div>

                            <div class="col-12 mb-3">
                                <label for="edit_NIM" class="form-label">Telefono</label>
                                <input type="number" name="nuevo_telefono" id="edit_direccion_envio" class="form-control" placeholder="telefono" required>
                            </div>
                            
                            <div class="col-12 mb-3">
                                <label for="edit_NIM" class="form-label">Precio</label>
                                <input type="text" name="nuevo_precio" id="edit_pais_envio" class="form-control" placeholder="precio" required>
                            </div>

                            <div class="col-12 mb-3">
                                <label for="edit_NIM" class="form-label">Cantidad</label>
                                <input type="text" name="nuevo_cantidad" id="edit_envio_coste" class="form-control" placeholder="cantidad" required>
                            </div>

                            <div class="col-12 mb-3">
                                <label for="edit_NIM" class="form-label">Nombre del producto</label>
                                <input type="text" name="nuevo_nom_producto" id="edit_total" class="form-control" placeholder="nom_producto" required>
                            </div>

                            <div class="col-12 mb-3">
                                <label for="edit_NIM" class="form-label">Correo del clíente</label>
                                <input type="text" name="nuevo_correo_cliente" id="edit_paqueteria" class="form-control" placeholder="correo_cliente" required>
                            </div>

                            <div class="col-12 mb-3">
                                <label for="edit_ipk" class="form-label">Número de factura</label>
                                <input type="text" name="nuevo_num_factura" id="edit_nombre_cuenta" class=" form-control" placeholder="num_factura" required>
                            </div>
